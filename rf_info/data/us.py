...
WIFI = RangeKeyDict([
    ...
    # 5.9ghz
    ((5850000000, 5895000001), ('802.11ax 5.9ghz U-NII-4')),

    # 6ghz
    ((5925000000, 6425000001), ('802.11ax/be 6ghz Wi-Fi 6E/7 U-NII-5')),
    ((6425000000, 6525000001), ('802.11ax/be 6ghz Wi-Fi 6E/7 U-NII-6 indoor/VLP')),
    ((6525000000, 6875000001), ('802.11ax/be 6ghz Wi-Fi 6E/7 U-NII-7')),
    ((6875000000, 7125000001), ('802.11ax/be 6ghz Wi-Fi 6E/7 U-NII-8 indoor/VLP')),
...
SERVICES = RangeKeyDict([
    ...
    ((1176450000, 1176450001), ("GPS L5 Receive Satellite Frequency")),

    # Intelligent Transportation Systems
    ((5895000000, 5925000001), ("C-V2X / Intelligent Transportation Systems")),

    # Mobile broadband / cellular
    ((617000000, 698000001), ("Mobile broadband 600 MHz band")),
    ((698000000, 806000001), ("Mobile broadband / public safety 700 MHz band")),
    ((806000000, 869000001), ("Cellular, SMR, and public safety 800 MHz band")),
    ((824000000, 849000001), ("Cellular 850 MHz uplink")),
    ((869000000, 894000001), ("Cellular 850 MHz downlink")),
    ((896000000, 901000001), ("SMR 900 MHz uplink")),
    ((935000000, 940000001), ("SMR 900 MHz downlink")),
    ((1710000000, 1780000001), ("AWS mobile broadband uplink")),
    ((2110000000, 2200000001), ("AWS mobile broadband downlink")),
    ((1850000000, 1915000001), ("PCS mobile broadband uplink")),
    ((1930000000, 1995000001), ("PCS mobile broadband downlink")),
    ((2496000000, 2690000001), ("BRS/EBS mobile broadband")),
    ((3450000000, 3550000001), ("3.45 GHz service")),
    ((3550000000, 3700000001), ("CBRS 3.5 GHz service")),
    ((3700000000, 3980000001), ("C-band mobile broadband")),
    ((24250000000, 24450000001), ("24 GHz mobile broadband")),
    ((24750000000, 25250000001), ("24 GHz mobile broadband")),
    ((27500000000, 28350000001), ("28 GHz mobile broadband")),
    ((37000000000, 40000000001), ("37/39 GHz mobile broadband")),
])
...
BROADCAST = RangeKeyDict([
    ...
    ((54000000, 72000001), ('VHF Television Channels 2-4')),
    ((76000000, 88000001), ('VHF Television Channels 5-6')),
    ((174000000, 216000001), ('VHF Television Channels 7-13')),
    ((470000000, 608000001), ('UHF Television Channels 14-36')),

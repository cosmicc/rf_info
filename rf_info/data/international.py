...
SATELLITES = RangeKeyDict({
    (435030000, 435180001): ('OSCAR 10', 'AO-10', 'LSB/CW', 'Uplink', 'Mode B Analog'),
    (145825000, 145975001): ('OSCAR 10', 'AO-11', 'LSB/CW', 'Downlink', 'Mode B Analog'),
    (145865000, 145905001): ('RS-10', 'RS-10', 'USB/CW', 'Uplink', 'ModeAAnalog'),
    (29360000, 29400001): ('RS-10', 'RS-10', None, 'Downlink', 'Mode A Analog'),
    (21210000, 21250001): ('RS-12', 'RS-12', 'USB/CW', 'Uplink', 'Mode K Analog'),
    (29410000, 29450001): ('RS-12', 'RS-12', None, 'Downlink', 'Mode K Analog'),
    (145910000, 145950001): ('RS-12', 'RS-12', None, 'Downlink', 'Mode K Analog'),
    (145858000, 145898001): ('RS-15', 'RS-15', None, 'Uplink', 'Mode A Analog'),
    (29354000, 29394001): ('RS-15', 'RS-15', None, 'Downlink', 'Mode A Analog'),
    (145900000, 146000001): ('JASIB', 'FO-20', 'LSB/CW', 'Uplink', 'Mode J Analog'),
    (435800000, 435900001): ('JASIB', 'FO-20', None, 'Downlink', 'Mode J Analog'),
    (145850000, 145850001): ('8J1JBS', None, 'AFSK FM', 'Uplink', '1200 Baud PSK'),
    (145890000, 145890001): ('8J1JBS', None, 'AFSK FM', 'Uplink', '1200 Baud PSK'),
    (145910000, 145910001): ('8J1JBS', None, 'AFSK FM', 'Uplink', '1200 Baud PSK'),
    (435910000, 435910001): ('8J1JBS', None, None, 'Downlink', '1200 Baud PSK'),
    (145900000, 146000001): ('JAS2', 'FO-29', 'AFSK FM', 'Uplink', 'Mode J Analog'),
    (435800000, 435900001): ('JAS2', 'FO-29', None, 'Downlink', 'Mode J Analog'),
    (145850000, 145850001): ('JAS2', None, 'AFSK FM', 'Uplink', '1200-9600 Baud PSK or DV'),
    (145870000, 145870001): ('JAS2', None, 'AFSK FM', 'Uplink', '1200-9600 Baud PSK or DV'),
    (145890000, 145890001): ('JAS2', None, 'AFSK FM', 'Uplink', '1200-9600 Baud PSK or DV'),
    (145910000, 145910001): ('JAS2', None, 'AFSK FM', 'Uplink', '1200-9600 Baud PSK or DV'),
    (435910000, 435910001): ('JAS2', None, None, 'Downlink', '1200 Baud PSK'),
    ...
    (145985000, 436800001): ('MIR', 'MIR', None, 'Uplink/Downlink', 'FM Voice and Packet'),
    (435750000, 435750001): ('SAFEX', None, None, 'Uplink', 'FM Voice; Repeater'),
    (435950000, 435950001): ('SAFEX', None, None, 'Downlink', 'FM Voice; Repeater'),
    (435725000, 435725001): ('SAFEX', None, None, 'Uplink', 'Dgr. Voice'),
    (435925000, 435925001): ('SAFEX', None, None, 'Downlink', 'Dgr. Voice'),
    (435975000, 435975001): ('SAFEX', None, None, 'Uplink', 'Packet'),
    (437975000, 437975001): ('SAFEX', None, None, 'Downlink', 'Packet'),
    (144490000, 144490001): ('SAREX', 'SHUTTLE', None, 'Uplink', '1200 Baud AFSK'),
    (144450000, 144450001): ('SAREX', 'SHUTTLE', None, 'Uplink', '1200 Baud AFSK/FM Voice'),
    (144470000, 144470001): ('SAREX', 'SHUTTLE', None, 'Uplink', 'FM Voice'),
    (145550000, 145550001): ('SAREX', 'SHUTTLE', None, 'Downlink', '1200 Baud AFSK/FM Voice'),
    (145815000, 145815001): ('SAREX', 'SHUTTLE', None, 'Downlink', '1200 Baud AFSK/FM Voice'),
    (145840000, 145840001): ('SAREX', 'SHUTTLE', None, 'Downlink', '1200 Baud AFSK/FM Voice'),
    ...
    (437015300, 437051301): ('PACAST', 'AO-16', 'FM', 'Downlink', '1200 Baud PSK'),
    (145825000, 145825001): ('DOVE', 'DO-17', None, 'Downlink', '1200 Baud PSK'),
    (2401220000, 2401220001): ('DOVE', 'DO-17', None, 'Downlink', '1200 Baud PSK'),
    (437075000, 437100001): ('WEBERSAT', 'WO-18', 'FM', 'Downlink', '1200 Baud PSK (img)'),
    (145840000, 145840001): ('LUSAT', 'LO-19', None, 'Uplink', '1200 Baud PSK'),
    (145860000, 145860001): ('LUSAT', 'LO-19', None, 'Uplink', '1200 Baud PSK'),
    (145880000, 145880001): ('LUSAT', 'LO-19', None, 'Uplink', '1200 Baud PSK'),
    (437125000, 437150001): ('LUSAT', 'LO-19', 'FM', 'Downlink', '1200 Baud PSK'),
    (145900000, 145900001): ('OSCAR-22', 'UO-22', None, 'Uplink', '9600 Baud AFSK'),
    (435120000, 435120001): ('OSCAR-22', 'UO-22', None, 'Downlink', '9600 Baud AFSK'),
    (145875000, 145875001): ('ITAMSAT', 'IO-26', None, 'Uplink', '1200 Baud PSK'),
    (145900000, 145900001): ('ITAMSAT', 'IO-26', None, 'Uplink', '1200 Baud PSK'),
    (145925000, 145925001): ('ITAMSAT', 'IO-26', None, 'Uplink', '1200 Baud PSK'),
    (145950000, 145950001): ('ITAMSAT', 'IO-26', 'FM', 'Uplink', '1200 Baud PSK'),
    (435822000, 435822001): ('ITAMSAT', 'IO-26', None, 'Downlink', '1200 Baud PSK'),
    (145850000, 145850001): ('KITSAT A (HL01)', 'KO-23', None, 'Uplink', '9600 Baud AFSK'),
    (145900000, 145900001): ('KITSAT A (HL01)', 'KO-23', None, 'Uplink', '9600 Baud AFSK'),
    (435173000, 435173001): ('KITSAT A (HL01)', 'KO-23', None, 'Downlink', '9600 Baud AFSK'),
    (145980000, 145980001): ('KITSAT B (HL02)', 'KO-25', None, 'Uplink', '9600 Baud AFSK'),
    (436500000, 436500001): ('KITSAT B (HL02)', 'KO-25', None, 'Downlink', '9600 Baud AFSK'),
})
